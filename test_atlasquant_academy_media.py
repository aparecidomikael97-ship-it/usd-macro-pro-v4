...
class AtlasQuantAcademyMediaTests(unittest.TestCase):
    ...
    def test_script_is_structured_and_conservative(self):
        ...
        self.assertTrue(item["detailed_blueprint_ready"])
        self.assertGreater(item["detailed_blueprint_seconds"],0)
        self.assertLessEqual(item["detailed_blueprint_seconds"],20*60)
