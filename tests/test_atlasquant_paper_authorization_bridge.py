...
def auth(exp):
 return {"approved":True,"risk_gate":"APPROVED","risk_auth_id":"RISK-1","expires_at":exp.isoformat(),"real_orders_enabled":False,"opportunity_id":"O1","pair":"EUR/USD","strategy_version":"AMD-1","max_authorized_risk":5,"max_authorized_exposure":5}
