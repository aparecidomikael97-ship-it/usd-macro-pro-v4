...
APP_VERSION = "10.7.6 — APPTEST SECRETS + API CIRCUIT BREAKER · MOTOR BASE V9.3.9.2"
HIST_SCORES = "historico_scores_v5.parquet"
HIST_SINAIS = "historico_sinais_v5.parquet"

st.set_page_config(
    page_title="USD Macro Pro V10.7.6 — AppTest Secrets + API Circuit Breaker",
    page_icon="🦅",
    layout="wide",
...
st.title("🦅 USD Macro Pro V10.7.6 — AppTest Secrets + API Circuit Breaker")
...
# ============================================================
st.markdown("## 🎛️ Central do Operador — Núcleo de Decisão V10.7.6")
...
abas = st.tabs([
    ...
    "📈 Teste Histórico",
    "🎯 Decisão Automática",
    "🧭 Macro Market Map V10.7.6",
    "✨ Aprenda & Personalize",
    "🚀 Produto V10.7.6",
    "🧭 Melhorias V10.7.6",
    "🌍 Notícias Globais V10.7.6",
    "🤖 AUTOPILOT V10.7.6",
])
