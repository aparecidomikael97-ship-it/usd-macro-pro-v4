...
APP_VERSION = "10.7.5 — HEADLESS SECRETS + API BUDGET · MOTOR BASE V9.3.9.2"
HIST_SCORES = "historico_scores_v5.parquet"
HIST_SINAIS = "historico_sinais_v5.parquet"

st.set_page_config(
    page_title="USD Macro Pro V10.7.5 — Full Autopilot Recovery",
    page_icon="🦅",
    layout="wide",
...
st.title("🦅 USD Macro Pro V10.7.5 — Full Autopilot Recovery")
...
# ============================================================
st.markdown("## 🎛️ Central do Operador — Núcleo de Decisão V10.7.5")
...
abas = st.tabs([
    ...
    "📈 Teste Histórico",
    "🎯 Decisão Automática",
    "🧭 Macro Market Map V10.7.5",
    "✨ Aprenda & Personalize",
    "🚀 Produto V10.7.5",
    "🧭 Melhorias V10.7.5",
    "🌍 Notícias Globais V10.7.5",
    "🤖 AUTOPILOT V10.7.5",
])
